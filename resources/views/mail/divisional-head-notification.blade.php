...
<p>I am writing to bring to your attention that there is a pending leave request awaiting your approval. <b>{{$staffDetails->name}}</b> grade <b>{{$staffDetails->title}}</b> has submitted a leave request, and it requires your authorization.</p>
